...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("valarmmall扫码支付，订单号：").append(outTradeNo).toString();
    ...
    public ServerResponse aliCallBack(Map<String, String> params) {
        ...
        if (order == null) {
            return ServerResponse.createByErrorMessage("非商城订单，订单忽略");
        }
    ...
    public ServerResponse cancel(Integer userId, Long orderNo) {
        ...
        // 通知支付宝订单取消
        int rowResult = orderMapper.updateByPrimaryKeySelective(updateOrder);
        if (rowResult > 0) {
            return ServerResponse.createBySuccess();
        }
        return ServerResponse.createByError();
