...
public class ProductServiceImpl implements IProductService {
    ...
    private ProductDetailVo assembleProductDetailVo(Product product) {
        ...
        // 读取配置文件设置图片地址前缀
        productDetailVo.setImageHost(PropertiesUtil.getProperty("ftp.server.http.prefix", "http://img.valarbore.com/"));
    ...
    public ServerResponse<PageInfo> getProductList(int pageNum, int pageSize) {
        ...
        return listConvertToVo(productList);
    }
    ...
    private ProductListVo assembleProductListVo(Product product) {
        ...
        productListVo.setImageHost(PropertiesUtil.getProperty("ftp.server.http.prefix", "http://img.valarbore.com/"));
    ...
    /**
     * 将查询得到的pojo列表装换为vo并与pageInfo组装
     *
     * @param productList
     * @return
     */
    private ServerResponse<PageInfo> listConvertToVo(List<Product> productList) {
